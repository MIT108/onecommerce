            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required class="form-control" value="{{ $_GET['id'] }}" name="blog_id" id="blog_id" hidden>
                    </div>
                </div>
                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <div class="d-flex text-capitalize align-items-center bg-gradient-primary justify-content-between text-bold border-radius-sm" style="width: 60px; height: 60px; font-size: 30px;">
                                ...
                                @foreach ($comments as $comment)
                                    <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                                        ...
                                        <div class="avatar me-3">
                                            <div class="d-flex text-capitalize align-items-center bg-gradient-primary justify-content-between text-bold border-radius-sm" style="width: 50px; height: 50px; font-size: 30px;">
                                        ...
                                        <div class="card card-blog card-plain">
                                            @if ($blog->image != "/storage/images/blog/")
                                                <div class="position-relative">
                                                    <a class="d-block shadow-xl border-radius-xl" href="{{ env('APP_URL') . $blog->image }}" target="_blank">
                                            ...
                                            <div class="card-body px-1 pb-0">
                                                <p class="text-gradient text-dark mb-2 text-sm">Blog ID #{{ $blog->id }}</p>
                                                ...
                                                <a class="d-flex align-items-center justify-content-between" href="/all-post?id={{ $blog->id }}">
